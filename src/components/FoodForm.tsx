...
export default function FoodForm({ initial, mode, onSubmit, onCancel }: Props) {
  ...
  const {
    ...
    defaultValues: {
      ...
      food_rating: initial?.rating ?? undefined,
  ...
  return (
    ...
    >
      <div> 
        ...
        />
        {errors.food_name && (
          <p id="food-name-error" className="text-sm text-red-400">
      ...
      <div> 
        ...
        />
        {errors.food_image && (
          <p id="food-image-error" className="text-sm text-red-400">
      ...
      <div> 
        ...
        {errors.restaurant_name && (
          <p id="restaurant-name-error" className="text-sm text-red-400">
      ...
      <div> 
        ...
        {errors.restaurant_logo && (
          <p id="restaurant-logo-error" className="text-sm text-red-400">
      ...
      <div> 
        ...
        <select
          ...
          className="food-input text-gray-700"
